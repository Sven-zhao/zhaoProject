require(['jquery', 'modules/ui/loadinglist/js/main', 'swig', 'common/jquery-plugins/iscroll','pagescript/prize1/base/js/wxshare'], function ($, LoadingList, swig) {
	...
	var listCreationMap = {
		"inLandList": function() {
			listMap['inLandList'] = new LoadingList($.extend({},commonLoadingListConf,{
				dataUrl: '/wmp/user/'+appConfigId+'/prize/ajax/getZhislandRankByPage',
		...
		"universList": function() {
			listMap['universList'] = new LoadingList($.extend({},commonLoadingListConf,{
				dataUrl: '/wmp/user/'+appConfigId+'/prize/ajax/getUserDingRankByPage',
