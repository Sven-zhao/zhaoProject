require(['jquery', 'modules/ui/loadinglist/js/main', 'swig', 'common/jquery-plugins/iscroll','pagescript/prize/base/js/wxshare'], function ($, LoadingList, swig) {
	...
	var listCreationMap = {
		...
		"universList": function() {
			listMap['universList'] = new LoadingList($.extend({},commonLoadingListConf,{
				dataUrl: '/wmp/user/'+appConfigId+'/prize/ajax/getUserAllRankByPage',
